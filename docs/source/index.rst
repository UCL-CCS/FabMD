.. FabMD documentation master file, created by
...
FabMD is a `FabSim3 <https://github.com/djgroen/FabSim3>`_ plugin for automated `LAMMPS <https://lammps.sandia.gov>`_-based simulations.
